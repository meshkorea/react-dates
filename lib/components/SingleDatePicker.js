  ...
  _createClass(SingleDatePicker, [{
    ...
    value: function () {
      function onChange(dateString) {
        ...
        var escaped = dateString.replace(/\D/g, '');
        var formattedString = [escaped.slice(0, 4), escaped.slice(4, 2), escaped.slice(6, 2)].filter(function (x) {
          return x;
        }).join('-');
        var newDate = (0, _toMomentObject2['default'])(formattedString, this.getDisplayFormat());
